 ...
 */
class Post extends \Data\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Data\\Entity\\Post' . "\0" . 'id', '' . "\0" . 'Data\\Entity\\Post' . "\0" . 'titulo', '' . "\0" . 'Data\\Entity\\Post' . "\0" . 'texto', '' . "\0" . 'Data\\Entity\\Post' . "\0" . 'autor'];
        }
